...
public class Controller implements Initializable {
    ...
    public long currentConnectTime;
    public boolean mustConnect = true;
    ...
    public void checkCloseConnection() {
        if (socket.isConnected()) {
            ...
            while (true) {
                ...
                if ((currentConnectTime - startConnectTime) > 120000) {  
                    try {
                        socket.close();
                        showAlert("Таймаут 120 секунд закончился");
                        mustConnect = false;
